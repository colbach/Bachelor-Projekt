...
public class Constants {
    ...
    public static final int CONNECT_OVERLAY_WIDTH = 600;
    ...
    public static final Color DEBUGGER_NODE_WAITING_BACKGROUND_COLOR = new Color(136, 141, 212);
    public static final Color DEBUGGER_NODE_WORKING_BACKGROUND_COLOR = new Color(188, 234, 188);
    public static final Color DEBUGGER_NODE_OTHER_BACKGROUND_COLOR = Color.lightGray;
    ...
    public static final Color MESSAGE_ERROR_BACKGROUND_COLOR = new Color(255, 121, 70);
    ...
    public static final Color LOG_ERR_TEXT_COLOR = Color.RED;
