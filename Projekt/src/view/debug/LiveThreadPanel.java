...
public class LiveThreadPanel extends JPanel {
    ...
    public void capture(Debugger debugger) {
        ...
        threadsWaitingRingStack[pointer] = debugger.getWaitingThreadCount();
        threadsWorkingRingStack[pointer] = debugger.getWorkingThreadCount();
        max = Math.max(max, threadsActiveRingStack[pointer]);
        
        /*System.out.println("threadsActive = " + threadsActiveRingStack[pointer]);
        System.out.println("threadsWaiting = " + threadsWaitingRingStack[pointer]);
        System.out.println("threadsWorking = " + threadsWorkingRingStack[pointer]);
