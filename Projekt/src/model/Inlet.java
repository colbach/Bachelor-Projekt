...
import exceptions.LetConnectException;
...
public class Inlet extends InOutlet {
    ...
    public Inlet(Type typ, String name, Node node, int inletIndex) {
        super(typ, name, node, inletIndex);
    }
    ...
    public boolean canConnectToOutlet(Outlet outlet) {
        ...
        System.err.println("**** CompatibilityTest.canTypeConnectToType(" + outlet.getType() + "," + getType() + ") return false");
        return false;
    }
    ...
    protected synchronized void unconnectOutlet(Outlet outlet) {
    ...
    public synchronized int getIndexForConnectedOutletInList(Outlet outlet) {
        ...
        System.err.println("outlet nicht in Liste gefunden.");
        return -1;
    }
