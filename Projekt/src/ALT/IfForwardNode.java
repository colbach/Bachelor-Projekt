...
public class IfForwardNode extends Node {
    
    private Type valueType = new GeneralType();
    
    private static String UNIQUE_NAME = "BuildIn.IfForwardNode";
    ...
    public IfForwardNode(int uiCenterX, int uiCenterY) {
        ...
        definition = new NodeDefinition() {
            ...
            public Class getClassForOutlet(int outletIndex) {
                return valueType.getTypeClass(); // beide Faelle
            }
