...
public class Calc implements NodeDefinition {
    ...
    public String getDescription() {
        return "Addiert, Subtrahiert, Multipliziert oder Dividiert zwei Werte." + TAG_PREAMBLE + " Rechner calculator addieren subtrahieren dividieren Math rechnen Taschenrechner mal plus minus geteilt";
    }
