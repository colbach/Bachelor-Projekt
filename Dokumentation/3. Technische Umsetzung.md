...
Eines der wichtigsten Komponenten des Hauptfensters ist die Toolbar. Diese basiert nicht auf einer vorgefertigten Komponente sondern wird selbst auf das Hauptpanel gezeichnet.Die Toolbar wird durch die gleichnamige Klasse `Toolbar` repräsentiert und durch Die Klasse `ToobarDrafter` gezeichnet.
...
#### Entwickelte allgemeine Komponenten
