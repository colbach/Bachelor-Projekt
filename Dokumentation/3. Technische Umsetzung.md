...
Folgende Fenster wurden für das Programm implementiert:

- Hauptfenster (`MainWindow`)
- Konsole (`ConsoleWindow`)
- Debug Monitor (`DebugMonitorWindow`)
- Bericht (`RunReportWindow`)
- Einstellungen (`SettingsWindow`)
- Erweiterte Einstellungen (`AdvancedSettingsWindow`)
- Element Auswahl (`NodeCollectionWindow`)
...
Wird das Programm gestartet ist 
