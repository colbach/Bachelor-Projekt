...
1. Anstossen aller vorhergehenden Elementen (an Eingängen verbunden). (Zustand 2)
2. Warten bis die Daten aller Eingänge im Kontext abrufbar sind. 
3. Liefern der Daten von Eingang "Objekt" an Ausgang "Falls Wahr" falls an Eingang "Wahrheitswert" `true` anliegt und an Ausgang "Falls Unwahr" sonst. (Zustand 4)
...
3. Liefern der Daten an verbunden Ausgang "Objekt". (Zustand 4)

Element *Schnellster Wert*:

1. Anstossen aller vorhergehenden Elementen (an Eingängen verbunden). (Zustand 2)
2. Warten bis die Daten **eines Eingang** im Kontext abrufbar sind.
3. Liefern der Daten an verbunden Ausgang "Wert". (Zustand 4)
...
2. Liefern der Daten an verbunden Ausgang "Wert". (Zustand 4)
