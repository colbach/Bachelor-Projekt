...
import reflection.CompatibilityTestable;
    ...
    public static CheckResult checkProject(Project project) {
        ...
        for (Node node : allNodes) {
            if (node instanceof CompatibilityTestable) {
                CompatibilityTestable.Result compatibilityTestableResult = ((CompatibilityTestable) node).testForCompatibility();
                if (compatibilityTestableResult != null) {
                    result.add(new CompatibilityCheckWarning(compatibilityTestableResult.getMessage(), compatibilityTestableResult.getUserMessage(), node));
                }
            }
        }
