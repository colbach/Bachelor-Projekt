...
import reflection.NoTriggerOutlet;
import reflection.NodeDefinition;
import reflection.VariableVisibleInletCount;
import reflection.VariableVisibleOutletCount;
...
public class Node {
    ...
    public String getInletName(int i) {
        ...
        if (i == definitionInletCount) {
            ...
            System.err.println("Inlet-Index ist zu gross! return UNKNOWN_LABEL.");
    ...
    public Type getInletType(int i) {
        ...
        if (i == definitionInletCount) {
            ...
            System.err.println("Inlet-Index ist zu gross! return VoidType.getInstance().");
            return VoidType.getInstance();
        } else {
    ...
    public String getOutletName(int i) {
        ...
        if (i == definitionOutletCount) {
            ...
            System.err.println("Outlet-Index ist zu gross! return UNKNOWN_LABEL");
            return UNKNOWN_LABEL;
        } else {
    ...
    public Type getOutletType(int i) {
        ...
        if (i == definitionOutletCount) {
            ...
            System.err.println("Outlet-Index ist zu gross! return VoidType.getInstance().");
            return VoidType.getInstance();
        } else {
    ...
    public int getVisibleInletCount() {
        if (definition instanceof FirstValueNodeDefinition) {
