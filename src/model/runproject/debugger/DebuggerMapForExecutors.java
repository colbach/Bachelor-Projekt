...
public class DebuggerMapForExecutors {
    ...
    private final HashMap<Tuple<Long, Node>, Long> contextIdentifierAndNodeToExecutor;
    ...
    public synchronized void registerExecutorIdentifier(Long identifier, Node node, String description, Long parentContextIdentifier) {
        ...
        contextIdentifierAndNodeToExecutor.put(new Tuple<>(parentContextIdentifier, node), identifier);
    ...
    public synchronized ExecutorState getNodeState(Node node, Long contextIdentifier) {
        Long executorIdentifier = contextIdentifierAndNodeToExecutor.get(new Tuple<>(contextIdentifier, node));
