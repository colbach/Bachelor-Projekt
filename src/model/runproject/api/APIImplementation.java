...
public class APIImplementation implements API {
    ...
    @Override
    public void saveImageToFileViaDialog(BufferedImage bufferedImage) {
        if (stillActive()) {
            ImageSaving.saveImageToFileViaDialogOnSwingThread(bufferedImage, viewOrNull, ".");
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public void saveImageToFileViaDialog(BufferedImage bufferedImage, String path) {
        if (stillActive()) {
            ImageSaving.saveImageToFileViaDialogOnSwingThread(bufferedImage, viewOrNull, path);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public void saveImageToFile(BufferedImage bufferedImage, String format, File file, boolean overwrite) throws IOException {
        if (stillActive()) {
            ImageSaving.saveImageToFile(bufferedImage, format, file, overwrite);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public BufferedImage loadImageFromFileViaDialog() throws Exception {
        if (stillActive()) {
            return ImageLoading.loadImageFromFileViaDialogOnSwingThread(".");
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public BufferedImage[] loadImagesFromFileViaDialog() throws Exception {
        if (stillActive()) {
            return ImageLoading.loadImagesFromFileViaDialogOnSwingThread(".", true);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public BufferedImage loadImageFromFile(File file) throws Exception {
        if (stillActive()) {
            return ImageLoading.loadImageFromFile(file);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public BufferedImage loadImageFromFileViaDialog(String path) throws Exception {
        if (stillActive()) {
            return ImageLoading.loadImageFromFileViaDialogOnSwingThread(path);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public BufferedImage[] loadImagesFromFileViaDialog(String path) throws Exception {
        if (stillActive()) {
            return ImageLoading.loadImagesFromFileViaDialogOnSwingThread(path, true);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public void saveByteArrayToFile(byte[] bs, File file) throws Exception {
        if (stillActive()) {
            FileHandling.saveByteArrayToFile(bs, file);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public void saveStringToFile(String s, File file) throws Exception {
        if (stillActive()) {
            FileHandling.saveStringToFile(s, file);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public byte[] loadByteArrayFromFile(File file) throws Exception {
        if (stillActive()) {
            return FileHandling.loadByteArrayFromFile(file);
        } else {
            throw new TerminatedException();
        }
    }
    ...
    @Override
    public String loadStringFromFile(File file) throws Exception {
        if (stillActive()) {
            return FileHandling.loadStringFromFile(file);
        } else {
            throw new TerminatedException();
        }
    }
