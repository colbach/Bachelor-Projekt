...
public class ForEachCollectPoint {
    ...
    private final HashMap<Tuple</*childElementContextIdentifier*/Long, /*Reduce*/ Node>, Object[]> collectedForEachDataForReduceNodes;
    private final HashMap<Tuple</*contextIdentifier*/Long, /*ForEach*/ Node>, Set</*childElementContextIdentifier */Long>> childElemtentSets;
    ...
    public synchronized void registerchildElemtentSets(Tuple</*contextIdentifier*/Long, /*ForEach*/ Node> forEachKeys, Set<Long> childElementContextIdentifiers) {
    ...
    public synchronized void deliverForEachData(Long childElementContextIdentifier, Node reduceNode, Object[] data) {
        collectedForEachDataForReduceNodes.put(new Tuple<>(childElementContextIdentifier, reduceNode), data);
        notifyAll();
    }

    private boolean canRetrieveForEachData(Tuple</*contextIdentifier*/Long, /*ForEach*/ Node> forEachKey, Node reduceNode) {
        Set<Long> get = childElemtentSets.get(forEachKey);
        if (get != null) {
            for (Long childElementContextIdentifier : get) {
                Tuple</*childElementContextIdentifier*/Long, /*Reduce*/ Node> key = new Tuple<>(childElementContextIdentifier, reduceNode);
    ...
    public synchronized Object[] collectForEachData(long contextIdentifier, Node reduceNode) {
        ...
        Tuple</*contextIdentifier*/Long, /*ForEach*/ Node> forEachKey = new Tuple<>(contextIdentifier, forEachNode);
