...
public class ShowRunningProject implements ShowState, LockableViewState, RunningViewState {
    ...
    public ShowRunningProject(ShowState previewsState) {
    ...
    public String toString() {
        return "ShowRunningProject{" + "message=" + message + ", error=" + error + ", previewsState=" + previewsState + ", backLock=" + backLock + '}';
    }
