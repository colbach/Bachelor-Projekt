            ...
            is.add(new RightClickMenueItem("Direkter Wert für Eingang setzen") {
                ...
                public void clicked() {
                    ...
                    for (Inlet inlet : node.getVisibleInlets()) {
                        RightClickMenueItem rcmi = new RightClickMenueItem(inlet.toString(), DirectInputSupport.isTypeSupported(inlet.getType())) {
                            @Override
                            public void clicked() {
                                ...
                                try {
                                    userInput = DirectInputDialogs.dialogForUserSettableContent(dind.getContentType(), new Object[]{}, mainWindow, project);
