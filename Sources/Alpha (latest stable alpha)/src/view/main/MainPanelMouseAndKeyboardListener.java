                ...
                if (ctrlPressed) { // Node verbinden...
                    ...
                    if (matchedNode != null) { // Falls Maus sich ueber einem Node befunden hat
                        ...
                        if (matchedNode.isDirectInputNode()) { // DirectInput-Node
                            ...
                            try {
                                newUserSettableContent = DirectInputDialogs.dialogForUserSettableContent(matchedNode.getUserSettableContentType(), matchedNode.getUserSettableContent(), mainPanel.getWindow(), mainPanel.getWindow().getProject());
