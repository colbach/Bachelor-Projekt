...
public class ResizeNodeDefinition implements NodeDefinition {
    ...
    public String getNameForInlet(int index) {
        switch (index) {
            case 0:
                return "Bild";
            case 1:
                return "Proportional skalieren";
            case 2:
                return "Verhältniss bewahren";
            case 3:
                return "Breite";
            case 4:
                return "Höhe";
    ...
    public String getName() {
        return "Bild skalieren";
    }

    @Override
    public String getDescription() {
        return "Skaliert Bild absolut oder relativ zur Ursprungsgrösse." + TAG_PREAMBLE + " [Grafik] Image Bild Grösse Größe Photo skalieren resize";
    }

    @Override
    public String getUniqueName() {
        return "buildin.ResizeImage";
    }

    @Override
    public String getIconName() {
        return "Resize-Image_30px.png";
    }
