...
public class MainPanelDrafter {
    ...
    public static void drawMainPanel(Graphics2D g, MainPanel mainPanel) {
        ...
        try {
            ...
            BackgroundDrafter.drawBackground(g, mainPanel.getOffX(), mainPanel.getOffY(), 0, 0, width, height);
            ...
            if (toolbar != null) {
                ...
                ToolbarDrafter.drawDummyToolbar((Graphics2D) g, width);
                heIsDeadJim = true;
            }
            ...
            if (heIsDeadJim) {
                ...
                int centerY = 300;
                if (mainPanel != null) {
                    centerX = mainPanel.getWidth() / 2;
                    centerY = mainPanel.getHeight() / 2;
                }
                HeIsDeadJimDrafter.draw(g, centerX, centerY);
            }
        }
    }
