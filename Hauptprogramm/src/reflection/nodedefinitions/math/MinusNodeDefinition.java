...
public class MinusNodeDefinition implements NodeDefinition {
    ...
    public String getDescription() {
        return "Zieht B von A ab." + TAG_PREAMBLE + " [Math] Minus abziehen Rechnen";
    }

    @Override
    public String getUniqueName() {
        return "buildin.Substract";
    }

    @Override
    public String getIconName() {
        return "Subtract_30px.png";
    }
    ...
    public void run(InOut io, API api) throws Exception {
        Object oA = io.in0(0, new NumberMathObject(0));
        Object oB = io.in0(1, new NumberMathObject(0));
        ...
        if (oA instanceof Number && oB instanceof Number) {
            ...
            if (oA instanceof Double && oB instanceof Double) {
                ...
                io.out(0, new NumberMathObject(dA - dB));
            }
        } else if (oA instanceof Vector && oB instanceof Vector) {

            io.out(0, MatrixAndVectorOperations.subtract(((Vector) oA), (Vector) oB));

        } else if (oA instanceof Matrix && oB instanceof Matrix) {

            io.out(0, MatrixAndVectorOperations.subtract(((Matrix) oA), (Matrix) oB));

        } else {
            throw new Exception(oA + " (" + oA.getClass() + ") kann nicht von " + oB + " (" + oB.getClass() + ") abgezogen werden.");
        }
    }
