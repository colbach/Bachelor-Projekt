...
public class MatrixInputDialog extends javax.swing.JDialog {
    ...
    public static Matrix showMatrixInputDialog(Matrix matrix, java.awt.Frame parent) {

        MatrixInputDialog codeInputDialog = new MatrixInputDialog(matrix, parent);
        codeInputDialog.setVisible(true);

        return codeInputDialog.result;
    }

    private final Matrix prototyp;
     ...
     */
    public MatrixInputDialog(Matrix matrix, java.awt.Frame parent) {
        super(parent, true);
        initComponents();

        this.prototyp = matrix;
        this.matrixBuilder = new MatrixBuilder(matrix);
    ...
    private void initComponents() {
        ...
        matrixInputPanel = new view.dialogs.matrixinput.MatrixInputPanel();
        ...
        matrixInputPanel.setFocusCycleRoot(true);
        matrixInputPanel.setFocusTraversalPolicyProvider(true);
        ...
        cSpinner.setModel(new javax.swing.SpinnerNumberModel(3, 1, 20, 1));
        cSpinner.setToolTipText("");
        cSpinner.setValue(3);
        ...
        cSpinner.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                cSpinnerMouseReleased(evt);
            }
        });
        cSpinner.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                cSpinnerPropertyChange(evt);
            }
        });
        cSpinner.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                cSpinnerKeyTyped(evt);
            }
        });
        ...
        jButton1.setText("Einheitsmatrix");
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        result = matrixBuilder.getMatrix();
        dispose();
    ...
    private void matrixInputPanelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_matrixInputPanelMousePressed
        Pair<Integer, Integer> indexForMousePosition = matrixInputPanel.select(evt.getX(), evt.getY());

        if (indexForMousePosition != null) {
            selectedRow = indexForMousePosition.l;
            selectedColumn = indexForMousePosition.r;
        } else {
            selectedRow = -1;
            selectedColumn = -1;
        }
    ...
    private void matrixInputPanelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_matrixInputPanelKeyPressed
        if (selectedRow >= 0 || selectedColumn >= 0) {
            matrixBuilder.appendToPreparedValue(selectedRow, selectedColumn, evt.getKeyChar());
    ...
    private void cSpinnerPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cSpinnerPropertyChange
        updateCounts();
    }//GEN-LAST:event_cSpinnerPropertyChange
    ...
    private void cSpinnerMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cSpinnerMouseReleased
        updateCounts();
    }//GEN-LAST:event_cSpinnerMouseReleased

    private void cSpinnerKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cSpinnerKeyTyped
        updateCounts();
    }//GEN-LAST:event_cSpinnerKeyTyped
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        matrixBuilder.setToUnitMatrix();
        repaint();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void updateCounts() {
        if (matrixBuilder != null) {
            matrixBuilder.setColumCount((int) cSpinner.getValue());
    ...
    private view.dialogs.matrixinput.MatrixInputPanel matrixInputPanel;
