...
public class LogWindow extends JFrame implements ActionListener {
    ...
    private final AdvancedLogger logger = AdvancedLogger.getGeneralInstance();
    ...
    public void enterCommandLine() {
        ...
        if (commandLinePrompt != null) {
            ...
            // Ausfuehren...
            commandLinePrompt.executeLineOnOwnThread(input);

            input = "";
            logPanel.setInput(input);
            repaint();
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        long counter = logger.getChangeCounter();
